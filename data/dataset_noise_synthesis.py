...
class dataset_noise_synthesis(dataset_base):
    ...
    def __getitem__(self, index):
        ...
        """
        For NeCA-W synthesized dataset path
        """
        clean_img_dir = noisy_img_dir.replace("./sRGB-Real-Noise-Synthesis/NeCA_W_images", "./SIDD_srgb_medium/Crop").replace("/noisy", "/clean")
